...
!function (e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            ...
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t)return u || (u = s ? e[a] = J.pop() || it.guid++ : a), l[u] || (l[u] = s ? {} : {toJSON: it.noop}), ("object" == typeof t || "function" == typeof t) && (r ? l[u] = it.extend(l[u], t) : l[u].data = it.extend(l[u].data, t)), o = l[u], r || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[it.camelCase(t)] = n), "string" == typeof t ? (i = o[t], null == i && (i = o[it.camelCase(t)])) : i = o, i
        }
    }
    ...
    function g(e, t) {
        var n, r, i = 0, o = typeof e.getElementsByTagName !== kt ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== kt ? e.querySelectorAll(t || "*") : void 0;
    ...
    function j(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)r = e[a], r.style && (o[a] = it._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && jt(r) && (o[a] = it._data(r, "olddisplay", S(r.nodeName)))) : (i = jt(r), (n && "none" !== n || !i) && it._data(r, "olddisplay", i ? n : it.css(r, "display"))));
    ...
    function M(e, t, n) {
        ...
        if (it.isEmptyObject(f))"inline" === ("none" === u ? S(e.nodeName) : u) && (p.display = u); else {
    ...
    function O(e, t, n) {
        ...
        for ($(c, u.opts.specialEasing); a > o; o++)if (r = bn[o].call(u, e, c, u.opts))return r;
    ...
    var J = [], G = J.slice, Y = J.concat, Q = J.push, K = J.indexOf, Z = {}, et = Z.toString, tt = Z.hasOwnProperty, nt = {}, rt = "1.11.1", it = function (e, t) {
    ...
    it.fn = it.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || it.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++)if (null != (i = arguments[s]))for (r in i)e = a[r], n = i[r], a !== n && (u && n && (it.isPlainObject(n) || (t = it.isArray(n))) ? (t ? (t = !1, o = e && it.isArray(e) ? e : []) : o = e && it.isPlainObject(e) ? e : {}, a[r] = it.extend(u, o, n)) : void 0 !== n && (a[r] = n));
        return a
    }, it.extend({
 ...
 */
        function (e) {
            ...
            function b(e, n) {
                var i = n.length > 0, o = e.length > 0, a = function (r, a, s, l, u) {
                    var c, d, f, p = 0, h = "0", m = r && [], v = [], y = j, b = r || o && T.find.TAG("*", u), x = P += null == y ? 1 : Math.random() || .1, w = b.length;
            ...
            var x, w, T, k, C, S, E, N, j, D, A, L, _, H, q, F, M, $, O, R = "sizzle" + -new Date, B = e.document, P = 0, W = 0, I = n(), z = n(), X = n(), U = function (e, t) {
                return e === t && (A = !0), 0
            }, V = "undefined", J = 1 << 31, G = {}.hasOwnProperty, Y = [], Q = Y.pop, K = Y.push, Z = Y.push, et = Y.slice, tt = Y.indexOf || function (e) {
            ...
            w = t.support = {}, C = t.isXML = function (e) {
                ...
                var n = T.attrHandle[t.toLowerCase()], r = n && G.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !q) : void 0;
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, S = t.tokenize = function (e, n) {
                ...
                return (u || E(e, d))(r, t, !q, n, bt.test(e) && c(t.parentNode) || t), n
        ...
        var t, n, r, i, a, s, l = [], u = !e.once && [], c = function (o) {
            ...
            add: function () {
                ...
                return l && it.each(arguments, function (e, n) {
                    for (var r; (r = it.inArray(n, l, r)) > -1;)l.splice(r, 1), t && (i >= r && i--, a >= r && a--)
                }), this
            }, has: function (e) {
    ...
    var Et = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Nt = ["Top", "Right", "Bottom", "Left"], jt = function (e, t) {
    ...
    var Lt = /^(?:input|select|textarea)$/i, _t = /^key/, Ht = /^(?:mouse|pointer|contextmenu)|click/, qt = /^(?:focusinfocus|focusoutblur)$/, Ft = /^([^.]*)(?:\.(.+)|)$/;
    it.event = {
        global: {},
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(bt) || [""], u = t.length; u--;)if (s = Ft.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function (t, n, r, i) {
            ...
            if (s = c = r = r || ht, 3 !== r.nodeType && 8 !== r.nodeType && !qt.test(p + it.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[it.expando] ? t : new it.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : it.makeArray(n, [t]), u = it.event.special[p] || {}, i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                ...
                for (d = 0; (s = f[d++]) && !t.isPropagationStopped();)t.type = d > 1 ? l : u.bindType || p, o = (it._data(s, "events") || {})[t.type] && it._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && it.acceptData(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
    ...
    var Mt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", $t = / jQuery\d+="(?:null|\d+)"/g, Ot = new RegExp("<(?:" + Mt + ")[\\s/>]", "i"), Rt = /^\s+/, Bt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Pt = /<([\w:]+)/, Wt = /<tbody/i, It = /<|&#?\w+;/, zt = /<(?:script|style|link)/i, Xt = /checked\s*(?:[^=]|=\s*.checked.)/i, Ut = /^$|\/(?:java|ecma)script/i, Vt = /^true\/(.*)/, Jt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Gt = {
    ...
    Gt.optgroup = Gt.option, Gt.tbody = Gt.tfoot = Gt.colgroup = Gt.caption = Gt.thead, Gt.th = Gt.td, it.extend({
        clone: function (e, t, n) {
            ...
            if (nt.html5Clone || it.isXMLDoc(e) || !Ot.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Qt.innerHTML = e.outerHTML, Qt.removeChild(o = Qt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || it.isXMLDoc(e)))for (r = g(o), s = g(e), a = 0; null != (i = s[a]); ++a)r[a] && k(i, r[a]);
            ...
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)if (o = e[h], o || 0 === o)if ("object" === it.type(o))it.merge(p, o.nodeType ? [o] : o); else if (It.test(o)) {
                for (s = s || f.appendChild(t.createElement("div")), l = (Pt.exec(o) || ["", ""])[1].toLowerCase(), c = Gt[l] || Gt._default, s.innerHTML = c[1] + o.replace(Bt, "<$1></$2>") + c[2], i = c[0]; i--;)s = s.lastChild;
                if (!nt.leadingWhitespace && Rt.test(o) && p.push(t.createTextNode(Rt.exec(o)[0])), !nt.tbody)for (o = "table" !== l || Wt.test(o) ? "<table>" !== c[1] || Wt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;)it.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
            ...
            for (var n, r, i, o, a = 0, s = it.expando, l = it.cache, u = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)if ((t || it.acceptData(n)) && (i = n[s], o = i && l[i])) {
        ...
        text: function (e) {
            ...
            return Dt(this, function (e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Ot.test(e) || !nt.leadingWhitespace && Rt.test(e) || Gt[(Pt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Bt, "<$1></$2>");
                    try {
            ...
            if (u && (s = it.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                ...
                if (i)for (a = o[o.length - 1].ownerDocument, it.map(o, x), l = 0; i > l; l++)r = o[l], Ut.test(r.type || "") && !it._data(r, "globalEval") && it.contains(a, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Jt, "")));
                s = n = null
            }
            return this
        }
    ...
    var an = /alpha\([^)]*\)/i, sn = /opacity\s*=\s*([^)]*)/, ln = /^(none|table(?!-c[ea]).+)/, un = new RegExp("^(" + Et + ")(.*)$", "i"), cn = new RegExp("^([+-])=(" + Et + ")", "i"), dn = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    var hn, mn, gn = /^(?:toggle|show|hide)$/, vn = new RegExp("^(?:([+-])=|)(" + Et + ")([a-z%]*)$", "i"), yn = /queueHooks$/, bn = [M], xn = {
        "*": [function (e, t) {
    ...
    it.Animation = it.extend(O, {
        ...
        fadeTo: function (e, t, n, r) {
            return this.filter(jt).css("opacity", 0).show().end().animate({opacity: t}, e, n, r)
    ...
    it.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, l = 0 > i ? s : o ? i : 0; s > l; l++)if (n = r[l], !(!n.selected && l !== i || (nt.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && it.nodeName(n.parentNode, "optgroup"))) {
    ...
    var Tn, kn, Cn = it.expr.attrHandle, Sn = /^(?:checked|selected)$/i, En = nt.getSetAttribute, Nn = nt.input;
    it.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            if (o && 1 === e.nodeType)for (; n = o[i++];)r = it.propFix[n] || n, it.expr.match.bool.test(n) ? Nn && En || !Sn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(En ? n : r)
        }, attrHooks: {
            type: {
                set: function (e, t) {
        ...
        Cn[t] = Nn && En || !Sn.test(t) ? function (e, t, r) {
            var i, o;
    ...
    it.fn.extend({
        addClass: function (e) {
            ...
            if (u)for (t = (e || "").match(bt) || []; l > s; s++)if (n = this[s], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(An, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(it.isFunction(e) ? function (n) {
                ...
                if ("string" === n)for (var t, r = 0, i = it(this), o = e.match(bt) || []; t = o[r++];)i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else(n === kt || "boolean" === n) && (this.className && it._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : it._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(An, " ").indexOf(t) >= 0)return !0;
            return !1
        }
    ...
    var qn, Fn, Mn = /#.*$/, $n = /([?&])_=[^&]*/, On = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Rn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Bn = /^(?:GET|HEAD)$/, Pn = /^\/\//, Wn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, In = {}, zn = {}, Xn = "*/".concat("*");
    try {
        Fn = location.href
    } catch (Un) {
    ...
    window.Store = function () {
        ...
        return n = function () {
            ...
            var n, i, o;
            try {
                return t = JSON.stringify(t), localStorage.setItem(e, t), t
            } catch (a) {
                for (n = a, i = o = 0; 5 >= o; i = ++o)localStorage.removeItem(localStorage.key(localStorage.length - 1));
                return r(e, t)
            }
        }, {
            set: r, get: function (e) {
                var t;
                return t = localStorage[e], t && JSON.parse(t)
            }, expire: function (e) {
                var t;
                return t = localStorage[e], localStorage.removeItem(e), t
            }
        }) : (e = function (e, t, n) {
            var r, i;
            return n ? (r = new Date, r.setTime(r.getTime() + 24 * n * 60 * 60 * 1e3), i = "; expires=" + r.toGMTString()) : i = "", document.cookie = e + "=" + t + i + "; path=/", t
        }, t = function (e) {
            var t, n, r, i;
            for (e += "=", i = document.cookie.split(";"), n = 0, r = i.length; r > n; n++)if (t = i[n], 0 === t.indexOf(e))return t.replace(/^\s+/, "").substring(e.length + 1, t.length);
            return null
        }, {
            set: function (t, n) {
                return e(t, n, 1)
            }, get: t, expire: function (t) {
                var n;
                return n = Store.get(t), e(t, "", -1), n
            }
        })
    }()
}.call(this), function () {
}.call(this), function () {
    var e, t, n, r, i, o, a, s, l, u, c, d, f, p, h, m, g, v, y, b, x, w, T, k, C, S, E;
    y = function (e) {
        var t, n, r, i, o;
        for (i = $(e), o = [], n = 0, r = i.length; r > n; n++)t = i[n], o.push(w(t));
        return o
    }, w = function (e) {
        var t, n, r, i;
        return n = e.value, r = $(e).closest("td").data("node"), i = $(e).next()[0].value, t = $("table.bracket").data("bracket_id"), null == t && (t = $("table.bracket").data("bracket").id), $.ajax({
            type: "PUT",
            url: "/teams/" + i,
            beforeSend: function (e) {
                return e.setRequestHeader("X-CSRF-Token", $('meta[name="csrf-token"]').attr("content"))
            },
            data: {"team[name]": n, "bracket[id]": t, "bracket[node]": r},
            success: function (i) {
                return C({node: r, data: i, name: n, bracket_id: t}), b(e.getWindow())
            },
        ...
        var t;
        return e.preventDefault(), t = e.target, $.ajax({
            type: "PUT", url: "/lock_names", beforeSend: function (e) {
                return e.setRequestHeader("X-CSRF-Token", $('meta[name="csrf-token"]').attr("content"))
            }, data: {fix_team_names: !0}, success: function () {
                return b(t.getWindow())
            }, error: function (e, t, n) {
                return T(n, t)
            }
        })
        ...
        var n, r, o, a;
        a = e.node, r = e.bracket_id, null != e.name ? Store.set(t(r, a, "name"), e.name) : null != e.winner && (Store.set(t(r, a, "winner"), e.winner), Store.set(t(r, a, "winners_label"), e.winners_label), Store.set(t(r, a, "is_new"), !0)), o = f(a), null != o && (n = $("select#game_" + o), n.empty(), n.append($.parseHTML(i(r, o))))
    }, c = function (e) {
        var t;
        return t = Store.get("a_" + e), null != t || (t = []), t
    }, f = function (e) {
        var t;
        return t = Store.get("d_" + e), null != t || (t = ""), t
    }, i = function (e, t) {
        var n, i, o, a, s;
        for (i = "<option value>Choose winner...</option>", s = c(t), o = 0, a = s.length; a > o; o++)n = s[o], i += r(e, n);
        return i
    }, r = function (e, t) {
        var n, r, i;
        return i = d(e, t), n = i[0], r = i[1], '\n<option value="' + r + '">' + n + "</option>"
    }, d = function (e, n) {
        var r, i;
        return r = Store.get(t(e, n, "name")), null != r ? (i = r, r = n) : (r = Store.get(t(e, n, "winners_label")), i = Store.get(t(e, r, "name"))), null == i && (i = ""), null == r && (r = ""), [i, r]
    }, o = function (e) {
        var t, n, r, i;
        for (i = $(e), n = 0, r = i.length; r > n; n++)t = i[n], S(t)
    }, S = function (e) {
        var t, n, r, i;
        n = $(e).attr("node"), i = $(e).find(":selected").val(), t = $("table.bracket").data("bracket_id"), r = $(e).find(":selected").text(), C({
            node: n,
            winner: r,
            bracket_id: t,
            winners_label: i
        ...
        var r, i, o, a;
        for (i = n(e, t), o = 0, a = i.length; a > o; o++)r = i[o], Store.set(r[0], r[1])
    }, n = function (e, n) {
        var r, i, o;
        return r = function () {
            var r;
            r = [];
            for (i in n)o = n[i], "label" !== i && r.push([t(e, n.label, i), o]);
            return r
        }()
    }, t = function (e, t, n) {
        return "" + e + "_" + t + "_" + n
        ...
        var n, r, i;
        for (Store.set("a_" + e, t), r = 0, i = t.length; i > r; r++)n = t[r], Store.set("d_" + n, e)
    }, p = function () {
        m(), h()
    }, m = function () {
        var e, t, n, r, i, o;
        for (t = $("table.bracket").data("bracket"), e = t.id, a(e), o = t.nodes, r = 0, i = o.length; i > r; r++)n = o[r], g(e, n);
        $("table.bracket").data("bracket", ""), $("table.bracket").data("bracket_id", e)
    }, h = function () {
        var e, t, n;
        t = $("table.bracket").data("ancestors");
        for (n in t)e = t[n], k(n, e)
    }, u = function (n, r) {
        var i, o;
        return e(r, n, "is_new") ? (o = Store.get(t(r, n, "winner")), i = Store.get(t(r, n, "winners_label")), [n, o, i]) : null
    }, s = function (e, n, r) {
        return Store.expire(t(e, n, r))
    }, e = function (e, n, r) {
        return null != Store.get(t(e, n, r))
    }, a = function (t) {
        var n, r, i;
        for (i = [], n = r = 63; r >= 1; n = --r)e(t, n, "is_new") && i.push(s(t, n, "is_new"));
        return i
    }, x = function (e) {
        var t, n, r, i, o;
        return e.preventDefault(), o = e.target, t = $("table.bracket").data("bracket_id"), i = function () {
            var e, i;
            for (i = [], n = e = 63; e >= 1; n = --e)null != (r = u(n, t)) && i.push(r);
            return i
        }(), $.ajax({
            contentType: "application/json",
            type: "PUT",
            url: $(o).closest("form").attr("action"),
            data: JSON.stringify({game_data: i}),
            success: function () {
                return a(t), b(o.getWindow())
            },
            error: function (e, t, n) {
                return T(n, t)
            }
        ...
        return e.preventDefault(), $.ajax({
            ...
            data: JSON.stringify({lock_players_brackets: !0}),
            success: function () {
                return b(target.getWindow())
            },
            error: function (e, t, n) {
                return T(n, t)
            }
        ...
        return $("input.team_name").on("change", function () {
            return function (e) {
                return y(e.target)
            }
        }(this)), $("select.game_winner").on("change", function () {
            return function (e) {
                return o(e.target)
            }
        }(this)), $("button#team_entry_done").on("click", function () {
            return function (e) {
                return l(e)
            }
        }(this)), $("button#submit_games").on("click", function () {
            return function (e) {
                return x(e)
            }
        }(this)), $("button#update_bracket").on("click", function () {
            return function (e) {
                return x(e)
            }
        }(this)), $("button#lock_players_brackets").on("click", function () {
            return function (e) {
                return v(e)
            }
        }(this)), $("table.bracket").one("focusin", function () {
            return function (e) {
                return p(e.target)
            }
        }(this))
